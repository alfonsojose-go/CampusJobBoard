...
![Thymeleaf](https://img.shields.io/badge/Thymeleaf-3-orange)
...
### Admin Dashboard
*Administrators can approve/reject employer registrations, moderate job postings, and view platform analytics.*

### Employer Portal
*Employers create and manage job postings with rich text descriptions, application links, and category tags.*

### Student View
*Students browse filtered listings by category, location, and job type with one-click application tracking.*
...
```bash
# Configure database credentials in application-prod.properties
